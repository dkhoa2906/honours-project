...
\chapter{REVIEW OF EXISTING KNOWLEDGE}
    ...
    physically performing it are not distinct processes \cite{Jeannerod1994}. When a person performs 
    ...
    hemisphere, while left-hand imagery activates the right \cite{Pfurtscheller2001}.
    ...
    unrelated brain regions \cite{Pfurtscheller2001}.
    ...
    the prediction task for the computer \cite{Blankertz2008}.
    ...
    Vector Machines (SVM) have been the standard classifiers \cite{Lotte2018}. They remain popular 
    ...
    motivation. In BCI, this is typically utilised during Neurofeedback training. 
    ...
    focuses, producing more pronounced ERD/ERS patterns \cite{Skola2019,Atilla2024}.
    ...
    game design process is critical. If a game is visually chaotic, it may 
...
\chapter{PRODUCT DESIGN}
    ...
    light \cite{Lotte2018}. This minimises the risk of technical failure during the implementation 
